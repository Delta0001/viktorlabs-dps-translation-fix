// ==UserScript==
// @name         viktorlabs-dps-translation-fix
// @namespace    http://tampermonkey.net/
// @version      1.0.0
// @description  Fix viktorlab.cn/akdata/dps/ to properly assign the english name since Google Translate can't fix it
// @author       Delta
// @match        https://viktorlab.cn/akdata/dps/
// @icon         https://www.google.com/s2/favicons?sz=64&domain=tampermonkey.net
// @grant        none
// @run-at       document-idle
// ==/UserScript==
// Generating this script: copy and paste the contents of script.js and replace the codeblock of var src. Add the 
// escape character '\' after every other backtick and dollar sign

(function() {
    'use strict';

    var src = `function redefineAKDATAObjects() {
