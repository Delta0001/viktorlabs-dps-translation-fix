...
class VikScraper():
  ...
  def scrape_operator(self, op_name, elite_level, op_level, mod_x, mod_level, enemy_def, enemy_mr):
    ...
    for skill_level in range(3):
      ...
      self.result["period_1"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__period").text
      self.result["sk_dps_1"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__s_dps").text
      self.result["av_dps_1"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__g_dps").text
