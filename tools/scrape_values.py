...
OPERATOR_CN_NAMES = ["埃拉托 ", "崖心", "雪雉", "初雪", "巫恋", "真理", "格劳克斯", "掠风", "空", "海蒂", "月禾", "九色鹿", "夏栎", "狮蝎", "绮良", "食铁兽", "见行者", "罗宾", "霜华", "贝娜", "风丸", "能天使", "空弦", "灰烬", "黑", "远牙", "W", "菲亚梅塔", "早露", "迷迭香", "假日威龙陈", "推进之王", "风笛", "嵯峨", "琴柳", "焰尾", "伊芙利特", "莫斯提马", "艾雅法拉", "刻俄柏", "夕", "异客", "卡涅利安", "澄闪", "黑键", "灵知", "安洁莉娜", "铃兰", "麦哲伦", "浊心斯卡蒂", "令", "傀影", "老鲤", "温蒂", "阿", "歌蕾蒂娅", "水月", "归溟幽灵鲨", "闪灵", "夜莺", "凯尔希", "流明", "星熊", "塞雷娅", "瑕光", "年", "泥岩", "森蚺", "号角", "山", "银灰", "棘刺", "陈", "艾丽妮", "煌", "史尔特尔", "赫拉格", "帕拉斯", "耀骑士临光", "暴行", "空爆", "月见夜", "猎蜂", "杰克", "夜魔", "格拉尼", "斯卡蒂", "阿米娅(近卫)"]
...
class VikScraper():
  ...
  def scrape_operator(self, op_name, elite_level, op_level, mod_x, mod_level, enemy_def, enemy_mr):
    ...
    for skill_level in range(3):
      ...
      self.result["period"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__period").text
      self.result["sk_dps"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__s_dps").text
      self.result["av_dps"+str(skill_level)] = self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .dps__g_dps").text
